...
<head>
    ...
    <link href="./styleHome.css" type="text/css" rel="stylesheet">
        <script>
            function playAudio() {
                var sound = new Audio('sounds/menu.mp3');
                sound.play();
            }
        </script>
    </head>
    ...
    <h1 style="text-align:center; font-weight: bold; color:white; background-color:#b1102b; padding:20px;" onclick="playAudio()">Welcome to Checkers</h1>
    <ul class="indexList">
